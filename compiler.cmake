...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=rv32imc -mabi=ilp32 -DN200_REVA=1 -D__ASM -DSOC_${CONFIG_SOC_NAME} -imacros${AUTOCONF_H}")
...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=rv32imc -mabi=ilp32 -nostdlib -DN200_REVA=1 -DSOC_${CONFIG_SOC_NAME} -imacros${AUTOCONF_H}")
...
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -march=rv32imc -mabi=ilp32 -DN200_REVA=1 -DSOC_${CONFIG_SOC_NAME} -imacros${AUTOCONF_H}")
